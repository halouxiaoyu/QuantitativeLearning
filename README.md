...
- **标签优化**：使用1.0%涨跌幅阈值，预测第二天涨跌，实现合理数据平衡
...
### 4. 模型训练与保存 (已优化)
- **算法选择**：随机森林、XGBoost
- **标签优化**：1.0%涨跌幅阈值，预测第二天涨跌，实现合理数据平衡
- 时间序列数据分割
- 交叉验证评估
- 模型性能指标
- 模型持久化存储
